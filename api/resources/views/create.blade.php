    ...
    <div class="w-full sm:px-6">
      <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
            ...
            <div class="w-full p-6">
                <form class="w-1/2" action="/create/register" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nome" name="nome" type="text">
                    </div>
                    <div class="mb-4">
                        <div class="flex">
